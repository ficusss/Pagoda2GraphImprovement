...
updated_knn_graph <- UpdateNNGraph(pagoda_data$graphs$PCA, clusters_pagoda_data,
...
updated_mnn_graph <- UpdateNNGraph(pagoda_data$graphs$PCA, clusters_pagoda_data,
                                   all_clusters, 15, graph.type = 'mnn')
...
qplot(n_edges_per_vertex, bins=50)
print(paste("kNN:", length(n_edges_per_vertex[n_edges_per_vertex == 0])))

n_edges_per_vertex <- Matrix::rowSums(igraph::as_adj(updated_mnn_graph))
qplot(n_edges_per_vertex, bins=50)
print(paste("mNN:", length(n_edges_per_vertex[n_edges_per_vertex == 0])))
