...
ggplot() + geom_point(
  aes(x = embeddings_corrected_graph[,1], y = embeddings_corrected_graph[,2], color=all_clusters),
  size=0.3, alpha=0.5)

ggplot() + geom_point(
  aes(x = embeddings_corrected_graph_d[,1], y = embeddings_corrected_graph_d[,2], color=all_clusters),
  size=0.3, alpha=0.5)
